...
const Warranty = () => {
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h1 className="text-3xl font-bold mb-3">Warranty and Repairs</h1>

      <p className="mb-3">
        The refurbished laptops provided under the “Missing Middle” initiative
        come with <strong>no formal warranty</strong>. Students are expected to
        take full responsibility for the care and maintenance of the device once
        it is issued.
      </p>
      ...
      <ul className="list-disc list-inside space-y-2 text-gray-800 mb-6">
        ...
        <li>
          Ensure software updates are performed regularly to maintain
          performance.
        </li>
        <li>
          Back up your important work using cloud storage (e.g., OneDrive
          provided by TUT).
        </li>
        <li>
          If technical issues arise, consult with the ICT support team for
      ...
      <p className="mb-3">
        While there is no official warranty, students may visit their campus ICT
        Faculty Office for guidance on basic troubleshooting or referrals to
