 ...
 return (
  <div className="d-flex vh-100% overflow-hidden" style={{ height: "100%" }}>
    ...
    <div style={backgroundStyle} className="flex-grow-1 p-4">
      ...
      {/* Welcome Text */}
      <h1 className="text-blue" style={{ color: "blue" }}>Admin Dashboard</h1>
      <p className="text-light" style={{ color: "black" }}>
       <i style={{ color: "black" }}>Welcome,</i>  <strong style={{ color: "black" }}>{adminInfo.initails}. {adminInfo.surname}.</strong>
      </p>
